...
category1 = Sales_Category(name="Suzuki", description = "Suzuki sold 2.85 million vehicles in the year 2016 and stood the 10th rank "+
       "beating Mercedes-Benz. The Japanese automaker stood with a market share of 3.1 percent in 2016 and growth of 0.3 percent.")
session.add(category1)
session.commit()
category2 = Sales_Category(name="PSA", description = "Groupe PSA is informally known as PSA, the French multinational manufacturer of"+
       "automobiles sold under the Peugeot, Citroen and DS Automobiles brands. PSA is predominantly present in the European, "+
       "South American and the Canadian region.", created_by = "", )
session.add(category2)
session.commit()
category3 = Sales_Category(name="FCA", description = "FCA", created_by = "", )
session.add(category3)
session.commit()
category4 = Sales_Category(name="Honda", description = "Honda", created_by = "", )
session.add(category4)
session.commit()
category5 = Sales_Category(name="Ford", description = "Ford", created_by = "", )
session.add(category5)
session.commit()
category6 = Sales_Category(name="General Motors", description = "General Motors", created_by = "", )
