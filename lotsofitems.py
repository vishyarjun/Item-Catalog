...
category1 = Sales_Category(name="SUZUKI", description="Suzuki", created_by="viswanathan.arjun@gmail.com")
session.add(category1)
session.commit()
category2 = Sales_Category(name="PSA", description="Groupe PSA", created_by="viswanathan.arjun@gmail.com")
session.add(category2)
session.commit()
category3 = Sales_Category(name="FCA", description="FCA", created_by="viswanathan.arjun@gmail.com")
session.add(category3)
session.commit()
category4 = Sales_Category(name="HONDA", description="Honda", created_by="viswanathan.arjun@gmail.com")
session.add(category4)
session.commit()
category5 = Sales_Category(name="FORD", description="Ford", created_by="viswanathan.arjun@gmail.com")
session.add(category5)
session.commit()
category6 = Sales_Category(name="GM", description="General Motors", created_by="viswanathan.arjun@gmail.com")
...
Sales_Item4 = Sales_Item(name="Maruti Suzuki Ertiga", description="Made with grade A beef",
...
Sales_Item5 = Sales_Item(name="Peugeot 3008 II", description="Peugeot 3008 II",
                     price="$1993",sales_category=category2,
                     created_by="viswanathan.arjun@gmail.com")
...
Sales_Item1 = Sales_Item(name="Citroen GS.",
						 description="Citroen GS.",
						 price="$7996$",
...
Sales_Item2 = Sales_Item(name="Alfa Romeo.",
						 description="Alfa Romeo.",
						 price="$2567$",
						 sales_category=category3,
						 created_by="viswanathan.arjun@gmail.com")

session.add(Sales_Item2)
session.commit()

Sales_Item3 = Sales_Item(name="Dodge.",
						 description="Dodge.",
						 price="1599$",
						 sales_category=category3,
						 created_by="viswanathan.arjun@gmail.com")
...
Sales_Item4 = Sales_Item(name="Fiat.",
						 description="Fiat.",
						 price="1276$",
						 sales_category=category3,
						 created_by="viswanathan.arjun@gmail.com")
...
Sales_Item5 = Sales_Item(name="Maserati.",
...
Sales_Item6 = Sales_Item(name="Jeep.",
						description="Jeep.",
						price="1200$",
						sales_category=category3,
						created_by="viswanathan.arjun@gmail.com")
